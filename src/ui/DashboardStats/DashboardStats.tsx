...
export default function DashboardStats({ type }: StatsProps) {
  ...
  return (
    <div className="w-full grid grid-cols-[1fr_1px_1fr] gap-[3%] 2xl:gap-[40px] p-[3.5%] 2xl:p-[24px] border-grey">
      <div className="flex justify-start items-start gap-[12px] 2xl:gap-[16px]">
        ...
        <div className="flex flex-col justify-start items-start gap-[14px]">
          ...
          <p className="font-tthoves text-darkBlue text-[30px] 2xl:text-[32px] font-medium">
            $58,764
